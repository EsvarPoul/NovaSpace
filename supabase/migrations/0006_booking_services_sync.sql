...
insert into public.services (
  ...
  ('studio-rent', 'Оренда студії · 600 грн./год.', 'studio', 'Studio rental from one hour. Photographer is paid separately when needed.', 60, 15, 15, 1, 5, 100)
on conflict (slug) do update set
  name = excluded.name,
  area = excluded.area,
